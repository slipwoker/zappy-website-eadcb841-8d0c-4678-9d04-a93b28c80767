        ...
        const validateField = function(input) {
            ...
            if (input.type === 'email' && value !== '') {
                if (!validateEmail(value)) {
                    showError(input, isRTL ? 'البريد الإلكتروني غير صالح' : 'Please enter a valid email address');
                    return false;
                }
            }
            ...
            if (input.type === 'tel' && value !== '') {
                ...
                if (!phoneRegex.test(value)) {
                    showError(input, isRTL ? 'رقم الهاتف غير صالح' : 'Please enter a valid phone number');
                    return false;
                }
            }
            ...
            if (isValid) {
                ...
                fetch(action, options)
                    ...
                    .catch(function(error) {
                        ...
                        errorMessage.style.cssText = 'background: #f8d7da; color: #721c24; padding: 1rem; border-radius: 4px; margin-top: 1rem; text-align: center;';
                        errorMessage.textContent = isRTL ? 'حدث خطأ. يرجى المحاولة مرة أخرى.' : 'An error occurred. Please try again.';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'eadcb841-8d0c-4678-9d04-a93b28c80767',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'eadcb841-8d0c-4678-9d04-a93b28c80767';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'eadcb841-8d0c-4678-9d04-a93b28c80767';
